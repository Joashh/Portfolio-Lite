                ...
                <div className='flex gap-2 2xl:h-full 2xl:px-4'>
                    ...
                    <div className="w-auto pt-8 pl-4  2xl:w-full 2xl:pt-20 2xl:pl-13">
                        <div className='flex pl-4'>
                            ...
                            <img class="h-40 rounded-lg 2xl:h-50" src="images/japan.jpg" alt="image description " />
                        ...
                        <div className='flex pl-4 pt-4'>
                            ...
                            <img className="h-40 min-w-60 rounded-lg 2xl:h-50 2xl:w-75" src="images/cert7.png" alt="image description" />
